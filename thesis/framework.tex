...
In der Literatur \cite{kw2007, tw2008, dj2006} finden sich für Selektion, Mutation und Rekombination Standardverfahren, die in Hinblick auf das zu lösende Optimierungsproblem ausgewählt werden können.
...
In diesem Kapitel wurde das Framework zur Link Discovery erläutert. Dies beinhaltete den modellierten Weltausschnitt und dessen konkrete Umsetzung auf eine Graph--Datenstruktur. Außerdem wurde der Prozess der Erzeugung, Anreicherung und Prioisierung der Beziehungen dieses Weltausschnittes definiert und beschrieben. Kookkurrenz wurde als Mittel zur Beziehungserzeugung vorgestellt, die gängigen Maße genannt und die Berechnung erläutert. Ferner wurden mögliche Datenquellen für die Anreicherung der Daten diskutiert sowie der Einsatz evolutionärer Algorithmen zur Beziehungsprioisierung detailliert beschrieben.

Nachdem in diesem Kapitel das Link--Discovery--Framework umfassend behandelt wurde, beschreibt das nächste Kapitel die konkrete Durchführung der Link Discovery.