...
Der Sørensen--Dice--Koeffizient \cite{st1948} \cite{ld1945}, oft auch nur als Dice--Koeffizient bezeichnet, entstand ursprünglich in der Biologie und wurde verwendet, um die Ähnlichkeit zwischen Proben zu berechnen. Heute findet er allgemeine Anwendung im Data Mining. Er ist definiert durch:
...
\begin{figure}
\centering
\includegraphics[width=0.25\textwidth]{basic_graph}
...
\begin{figure}
\centering
\includegraphics[width=0.25\textwidth]{directed_graph}
...
\begin{figure}
\centering
\includegraphics[width=0.25\textwidth]{directed_multigraph}
