...
Das komplette Datenmodell des Graphen nach der Integration aller Datenquellen ist in \cref{complete_data_model} dargestellt.
...
Das resultierende Knotenmodell ist in \cref{fig:node_erd} dargestellt.
...
Das beschriebene Kantenmodell ist in \cref{fig:edge_erd} dargestellt.
