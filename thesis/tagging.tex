...
Die Korrektheit der Tagging--Daten kann an vielen Punkten angezweifelt werden. Das hervorstechende Problem hierbei ist das Auftreten von Spam. Viele Partner versehen ihre Artikel und Designs mit Tags, die nicht den Inhalt beschreiben. So werden beispielsweise falsche Tags vergeben, damit die getaggten Produkte bei populären Suchbegriffen in der Ergebnisliste erscheinen.
